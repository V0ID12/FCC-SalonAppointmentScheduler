...
INSERT INTO public.appointments VALUES (7, 28, 1, '10:30');
INSERT INTO public.appointments VALUES (8, 29, 2, '11:30');
...
INSERT INTO public.customers VALUES (22, '555-555-5555', 'Donovan');
INSERT INTO public.customers VALUES (28, '777-777-7777', 'Jake');
INSERT INTO public.customers VALUES (29, '000-000-0000', 'Rob');
...
ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fk_customer_id FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id) MATCH FULL;
...
ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fk_service_id FOREIGN KEY (service_id) REFERENCES public.services(service_id) MATCH FULL;
